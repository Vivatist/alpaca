...
class TestWorkerConcurrency:
    ...
    # TODO: Тест нестабильный из-за race condition в отслеживании параллельности
    # Требует более сложной синхронизации для корректного подсчёта max_concurrent_parsing
    # @responses.activate
    ...
    # TODO: Тест нестабильный из-за race condition в отслеживании параллельности
    # Требует более сложной синхронизации для корректного подсчёта max_concurrent_embedding
    # @responses.activate
